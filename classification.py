...
vanilar_logistic_param_grid = {"penalty": ["none"]}

aic_result_tuple = cf.model_fitting(model=vanilla_logistic_model, param_grid=vanilar_logistic_param_grid,
                                   dt_fun=cf.aic_logisitc_dt)

bic_result_tuple = cf.model_fitting(model=vanilla_logistic_model, param_grid=vanilar_logistic_param_grid,
...
# logistic_param_grid = {'C': np.linspace(60, 300, num=100)}
...
logistic_param_grid = {'C': np.logspace(0.1, 1, 100)}
...
logistic_param_grid = {'C': np.logspace(0.1, 2, 200)}
...
# L2 full model
logistic_param_grid = {'C': np.logspace(0.1, 2, 100)}
...
svm_param_grid = {'C': np.linspace(1, 100, num=50), 'degree': [3]}
